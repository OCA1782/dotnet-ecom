...
# 1. sudo apt ile psycopg2 kurulumu denendi — sonucu kontrol et
print('=== [1] psycopg2 apt kurulum kontrol ===')
print(run('python3 -c "import psycopg2; print(psycopg2.__version__)" 2>&1'))

# 2. Yoksa sudo apt ile kur
print('\n=== [2] sudo apt-get install python3-psycopg2 ===')
r = run('sudo apt-get install -y python3-psycopg2 2>&1', timeout=300)
print(r[-1500:])
