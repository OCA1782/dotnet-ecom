          ...
          <div className="flex items-center justify-between py-4 gap-6 flex-wrap" data-header-inner>
            ...
            <Link href="/" data-slot="logo" className="flex-shrink-0 flex items-center gap-2">
              {logoUrl ? (
                ...
                <img src={logoUrl} alt={siteName ?? "Mağaza"} style={{ height: "40px", width: "auto", maxWidth: "180px", objectFit: "contain" }} />
              ) : logoIconUrl ? (
                <>
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src={logoIconUrl} alt={siteName ?? "Mağaza"} style={{ height: "36px", width: "auto", objectFit: "contain" }} />
