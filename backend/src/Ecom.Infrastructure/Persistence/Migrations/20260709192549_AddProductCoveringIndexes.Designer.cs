...
namespace Ecom.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260709192549_AddProductCoveringIndexes")]
    partial class AddProductCoveringIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecom.Domain.Entities.AiTaskImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AiTaskImages");
                });

            modelBuilder.Entity("Ecom.Domain.Entities.AlertCondition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Ecom.Domain.Entities.Brand", b =>
                {
                    ...
                    b.Property<bool>("ShowInVehicleNav")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Ecom.Domain.Entities.DeployServer", b =>
                {
                    ...
                    b.Property<int?>("LastDeployDurationSeconds")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecom.Domain.Entities.ExternalSource", b =>
                {
                    ...
                    b.Property<string>("LastExcelFilePath")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Ecom.Domain.Entities.ExternalSourceImportLog", b =>
                {
                    ...
                    b.Property<string>("SkipDiagnosticsJson")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Ecom.Domain.Entities.LicenseAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Ecom.Domain.Entities.MailLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Ecom.Domain.Entities.MailTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("DefaultBodyHtml")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("IsBodyEditable")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("SampleVariables")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Ecom.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasIndex("IsDeleted", "IsActive", "IsPublished")
            ...
            modelBuilder.Entity("Ecom.Domain.Entities.AiTaskImage", b =>
                {
                    b.HasOne("Ecom.Domain.Entities.AiTask", "AiTask")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("Ecom.Domain.Entities.DeployLog", b =>
                {
                    b.HasOne("Ecom.Domain.Entities.DeployServer", "Server")
                        .WithMany("Logs")
